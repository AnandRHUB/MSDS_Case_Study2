...
#### <span style="color:INDIANRED"><b>Setting environment and parameters</span></b>
...
5. Run a permutation test to get the most effective combination 
...
Model accuracy is around 85%, meaning the data will predict attrition of employee correctly.
...
The Management can take the following action to prevent and redduce employee attrition.

1. Preventing the employee from leaving company by identifying the individual with characteristics mentioned.
2. Incentives for work well done and promotions/pay rise
3. More perks 
4. Stock options to partake in company profits
5. Employer sponsored events
6. Overtime and work life balance

=======
###Prepared by Anand Rajan and Shantanu Godbole from DDSAnalytics
* Version of R used for the case study
...
This write-up is supplemented by video presentations from both consultants of DSSAnalytics. The links are provided below.

Anand: Presentation of powerpoint slides video on YouTube - [link](https://youtu.be/-jxikHrZJVo)
Shantanu: Presentation of Power point slides on youtube - [link](https:..link here)
